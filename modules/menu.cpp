...
static ImVec4 FramerateColor(ImVec4)
{
...
void ShowMainMenu()
{
	...
	if (g_bMenuEnabled)
	{
		...
		if (s_bMenuVisuals)
		{
			...
			if (g_Config.cvars.menu_auto_resize)
			ImGui::Begin("Visuals", &s_bMenuVisuals, ImGuiWindowFlags_AlwaysAutoResize);
			else
			ImGui::Begin("Visuals", &s_bMenuVisuals);
			{
		...
		if (s_bMenuHud)
		{
			...
			if (g_Config.cvars.menu_auto_resize)
				ImGui::Begin("HUD", &s_bMenuHud, ImGuiWindowFlags_AlwaysAutoResize);
			else
				ImGui::Begin("HUD", &s_bMenuHud);
			{
				if (ImGui::BeginTabBar("##tabs"))
				{
					// Speedometer
		...
		if (s_bMenuUtility)
		{
			...
			if (g_Config.cvars.menu_auto_resize)
				ImGui::Begin("Utility", &s_bMenuUtility, ImGuiWindowFlags_AlwaysAutoResize);
			else
				ImGui::Begin("Utility", &s_bMenuUtility);
			{
				if (ImGui::BeginTabBar("##tabs"))
				{
					// Player
		...
		if (s_bMenuSettings)
		{
			...
			{
			    ImGui::Begin("Settings", &s_bMenuSettings);
		    }
