...
extern void ClientDLL_ReadDemoBuffer( int size, unsigned const char *buffer );
extern int ClientDLL_ConnectionlessPacket( const struct netadr_s *net_from, const char *args, const char *response_buffer, int *response_buffer_size );
