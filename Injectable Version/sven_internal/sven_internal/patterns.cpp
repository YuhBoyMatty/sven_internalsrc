...
namespace Patterns
{
	...
	{
		DEFINE_PATTERN(EngineFuncs, "68 ? ? ? ? FF 15 ? ? ? ? A1 ? ? ? ? 83 C4 1C 85 C0 74 0A 68");
		DEFINE_PATTERN(ClientFuncs, "FF E0 68 ? ? ? ? FF 35 ? ? ? ? E8 ? ? ? ? 83 C4 08 A3");
		DEFINE_PATTERN(EngineStudio, "68 ? ? ? ? 68 ? ? ? ? 6A 01 FF D0 83 C4 0C 85 C0");
	}
	...
	namespace Hardware
	{
		...
		DEFINE_PATTERN(V_SetupFrame, "83 EC 24 A1 ? ? ? ? 33 C4 89 44 24 20 33 C0 83 3D ? ? ? ? 01 0F 9F C0 50 E8 ? ? ? ? E8");
