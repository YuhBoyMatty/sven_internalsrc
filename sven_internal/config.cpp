...
bool CConfig::Load()
{
	...
	INI_IMPORT_BEGIN_SECTION("SETTINGS");
		...
		INI_IMPORT_VARIABLE("AutoResize", ImGuiAutoResize);
	...
	INI_IMPORT_BEGIN_SECTION("CHAMS");
		...
		INI_IMPORT_VARIABLE("ChamsItems", cvars.chams_items);
		...
		INI_IMPORT_VARIABLE("ChamsItemsWall", cvars.chams_items_wall);
		...
		INI_IMPORT_VARIABLE("ChamsItemsColor_R", cvars.chams_items_color[0]);
		INI_IMPORT_VARIABLE("ChamsItemsColor_G", cvars.chams_items_color[1]);
		INI_IMPORT_VARIABLE("ChamsItemsColor_B", cvars.chams_items_color[2]);
		...
		INI_IMPORT_VARIABLE("ChamsItemsWallColor_R", cvars.chams_items_wall_color[0]);
		INI_IMPORT_VARIABLE("ChamsItemsWallColor_G", cvars.chams_items_wall_color[1]);
		INI_IMPORT_VARIABLE("ChamsItemsWallColor_B", cvars.chams_items_wall_color[2]);
	INI_IMPORT_END_SECTION();
	...
	INI_IMPORT_BEGIN_SECTION("GLOW");
		...
		INI_IMPORT_VARIABLE("GlowItems", cvars.glow_items);
		...
		INI_IMPORT_VARIABLE("GlowItemsColor_R", cvars.glow_items_color[0]);
		INI_IMPORT_VARIABLE("GlowItemsColor_G", cvars.glow_items_color[1]);
		INI_IMPORT_VARIABLE("GlowItemsColor_B", cvars.glow_items_color[2]);
	INI_IMPORT_END_SECTION();

	INI_IMPORT_BEGIN_SECTION("DYNAMICGLOW");
		INI_IMPORT_VARIABLE("GlowAttach", cvars.dyn_glow_attach);
		INI_IMPORT_VARIABLE("GlowSelf", cvars.dyn_glow_self);
		INI_IMPORT_VARIABLE("GlowSelfRadius", cvars.dyn_glow_self_radius);
		INI_IMPORT_VARIABLE("GlowSelfDecay", cvars.dyn_glow_self_decay);
		INI_IMPORT_VARIABLE("GlowSelfColor_R", cvars.dyn_glow_self_color[0]);
		INI_IMPORT_VARIABLE("GlowSelfColor_G", cvars.dyn_glow_self_color[1]);
		INI_IMPORT_VARIABLE("GlowSelfColor_B", cvars.dyn_glow_self_color[2]);
		INI_IMPORT_VARIABLE("GlowPlayers", cvars.dyn_glow_players);
		INI_IMPORT_VARIABLE("GlowPlayersRadius", cvars.dyn_glow_players_radius);
		INI_IMPORT_VARIABLE("GlowPlayersDecay", cvars.dyn_glow_players_decay);
		INI_IMPORT_VARIABLE("GlowPlayersColor_R", cvars.dyn_glow_players_color[0]);
		INI_IMPORT_VARIABLE("GlowPlayersColor_G", cvars.dyn_glow_players_color[1]);
		INI_IMPORT_VARIABLE("GlowPlayersColor_B", cvars.dyn_glow_players_color[2]);
		INI_IMPORT_VARIABLE("GlowEntities", cvars.dyn_glow_entities);
		INI_IMPORT_VARIABLE("GlowEntitiesRadius", cvars.dyn_glow_entities_radius);
		INI_IMPORT_VARIABLE("GlowEntitiesDecay", cvars.dyn_glow_entities_decay);
		INI_IMPORT_VARIABLE("GlowEntitiesColor_R", cvars.dyn_glow_entities_color[0]);
		INI_IMPORT_VARIABLE("GlowEntitiesColor_G", cvars.dyn_glow_entities_color[1]);
		INI_IMPORT_VARIABLE("GlowEntitiesColor_B", cvars.dyn_glow_entities_color[2]);
		INI_IMPORT_VARIABLE("GlowItems", cvars.dyn_glow_items);
		INI_IMPORT_VARIABLE("GlowItemsRadius", cvars.dyn_glow_items_radius);
		INI_IMPORT_VARIABLE("GlowItemsDecay", cvars.dyn_glow_items_decay);
		INI_IMPORT_VARIABLE("GlowItemsColor_R", cvars.dyn_glow_items_color[0]);
		INI_IMPORT_VARIABLE("GlowItemsColor_G", cvars.dyn_glow_items_color[1]);
		INI_IMPORT_VARIABLE("GlowItemsColor_B", cvars.dyn_glow_items_color[2]);
	INI_IMPORT_END_SECTION();
...
void CConfig::Save()
{
	...
	INI_EXPORT_BEGIN_SECTION("SETTINGS");
		...
		INI_EXPORT_VARIABLE("AutoResize", ImGuiAutoResize);
	...
	INI_EXPORT_BEGIN_SECTION("CHAMS");
		...
		INI_EXPORT_VARIABLE("ChamsItems", cvars.chams_items);
		...
		INI_EXPORT_VARIABLE("ChamsItemsWall", cvars.chams_items_wall);
		...
		INI_EXPORT_VARIABLE("ChamsItemsColor_R", cvars.chams_items_color[0]);
		INI_EXPORT_VARIABLE("ChamsItemsColor_G", cvars.chams_items_color[1]);
		INI_EXPORT_VARIABLE("ChamsItemsColor_B", cvars.chams_items_color[2]);
		...
		INI_EXPORT_VARIABLE("ChamsItemsWallColor_R", cvars.chams_items_wall_color[0]);
		INI_EXPORT_VARIABLE("ChamsItemsWallColor_G", cvars.chams_items_wall_color[1]);
		INI_EXPORT_VARIABLE("ChamsItemsWallColor_B", cvars.chams_items_wall_color[2]);
	INI_EXPORT_END_SECTION();
	...
	INI_EXPORT_BEGIN_SECTION("GLOW");
		...
		INI_EXPORT_VARIABLE("GlowItems", cvars.glow_items);
		...
		INI_EXPORT_VARIABLE("GlowItemsColor_R", cvars.glow_items_color[0]);
		INI_EXPORT_VARIABLE("GlowItemsColor_G", cvars.glow_items_color[1]);
		INI_EXPORT_VARIABLE("GlowItemsColor_B", cvars.glow_items_color[2]);
	INI_EXPORT_END_SECTION();

	INI_EXPORT_BEGIN_SECTION("DYNAMICGLOW");
		INI_EXPORT_VARIABLE("GlowAttach", cvars.dyn_glow_attach);
		INI_EXPORT_VARIABLE("GlowSelf", cvars.dyn_glow_self);
		INI_EXPORT_VARIABLE("GlowSelfRadius", cvars.dyn_glow_self_radius);
		INI_EXPORT_VARIABLE("GlowSelfDecay", cvars.dyn_glow_self_decay);
		INI_EXPORT_VARIABLE("GlowSelfColor_R", cvars.dyn_glow_self_color[0]);
		INI_EXPORT_VARIABLE("GlowSelfColor_G", cvars.dyn_glow_self_color[1]);
		INI_EXPORT_VARIABLE("GlowSelfColor_B", cvars.dyn_glow_self_color[2]);
		INI_EXPORT_VARIABLE("GlowPlayers", cvars.dyn_glow_players);
		INI_EXPORT_VARIABLE("GlowPlayersRadius", cvars.dyn_glow_players_radius);
		INI_EXPORT_VARIABLE("GlowPlayersDecay", cvars.dyn_glow_players_decay);
		INI_EXPORT_VARIABLE("GlowPlayersColor_R", cvars.dyn_glow_players_color[0]);
		INI_EXPORT_VARIABLE("GlowPlayersColor_G", cvars.dyn_glow_players_color[1]);
		INI_EXPORT_VARIABLE("GlowPlayersColor_B", cvars.dyn_glow_players_color[2]);
		INI_EXPORT_VARIABLE("GlowEntities", cvars.dyn_glow_entities);
		INI_EXPORT_VARIABLE("GlowEntitiesRadius", cvars.dyn_glow_entities_radius);
		INI_EXPORT_VARIABLE("GlowEntitiesDecay", cvars.dyn_glow_entities_decay);
		INI_EXPORT_VARIABLE("GlowEntitiesColor_R", cvars.dyn_glow_entities_color[0]);
		INI_EXPORT_VARIABLE("GlowEntitiesColor_G", cvars.dyn_glow_entities_color[1]);
		INI_EXPORT_VARIABLE("GlowEntitiesColor_B", cvars.dyn_glow_entities_color[2]);
		INI_EXPORT_VARIABLE("GlowItems", cvars.dyn_glow_items);
		INI_EXPORT_VARIABLE("GlowItemsRadius", cvars.dyn_glow_items_radius);
		INI_EXPORT_VARIABLE("GlowItemsDecay", cvars.dyn_glow_items_decay);
		INI_EXPORT_VARIABLE("GlowItemsColor_R", cvars.dyn_glow_items_color[0]);
		INI_EXPORT_VARIABLE("GlowItemsColor_G", cvars.dyn_glow_items_color[1]);
		INI_EXPORT_VARIABLE("GlowItemsColor_B", cvars.dyn_glow_items_color[2]);
	INI_EXPORT_END_SECTION();
